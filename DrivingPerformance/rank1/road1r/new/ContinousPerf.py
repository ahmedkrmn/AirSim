# Helper function to get the continous performance with moving upward in right lane. 
def upwardRight(roadDims,x,y):
...
# Helper function to get the continous performance with moving leftward in up lane. 
def leftwardup(roadDims,x,y):
...
# Helper function to get the continous performance with moving upward in left lane. 
def upwardLeft(roadDims,x,y):
    half = roadDims[1][0] + abs(roadDims[1][0]-roadDims[1][1])/2
...
# Helper function to get the continous performance with moving leftward in down lane. 
def leftwardDown(roadDims,x,y):
    half = roadDims[0][0] + abs(roadDims[0][0]-roadDims[0][1])/2
