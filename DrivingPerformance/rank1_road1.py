...
strip_1 = [[159, 161], [-6, 4]]
strip_2 = [[165, 173], [10, 11]]

# Define the ranges for turning performance
Rang1_1 = [[169, 171], [-9.5, -10.5]]
Rang1_2 = [[171, 171.5], [-9.5, -10.5]]
Rang2_1 = [[168, 169], [-9.5, -10.5]]
Rang2_2 = [[171.5, 172.5], [-9.5, -10.5]]
Rang3_1 = [[167, 168], [-9.5, -10.5]]
Rang3_2 = [[172.5, 173], [-9.5, -10.5]]
Rang4_1 = [[166, 167], [-9.5, -10.5]]
Rang4_2 = [[173, 174], [-9.5, -10.5]]
Rang5_1 = [[164, 166], [-9.5, -10.5]]
Rang5_2 = [[174, 300], [-9.5, -10.5]]

# Define the speed sign place
Speed_sign = [[165, 173.5], [-114.5, -115.5]]
crossed_ssign = False

crossed_1 = False

#log_path = path.expanduser('~\\Documents\\AirSim\\airsim_rec.txt')
log_path = path.expanduser('airsim_rec.txt')
